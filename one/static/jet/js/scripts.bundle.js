  ...
  if (null != e) {
    var i = {
      ...
      a = function (e) {
        null !== e &&
          !0 !== m(e) &&
          ('dropdown' === T(e) ? U(e) : 'accordion' === T(e) && S(e),
          KTUtil.data(e).set('type', T(e)));
      },
      l = function (e) {
        null !== e &&
          !1 !== m(e) &&
          ('dropdown' === T(e) ? b(e) : 'accordion' === T(e) && A(e));
      },
      s = function (e) {
        if (!1 !== f(e)) {
          var t = p(e);
          KTUtil.data(e).has('type') &&
            KTUtil.data(e).get('type') !== T(e) &&
      ...
      S = function (e) {
        if (
          ...
          !1 === n.options.accordion.expand && C(e);
          var t = p(e);
          !0 === KTUtil.data(e).has('popper') && b(e),
    ...
    !0 === KTUtil.data(e).has('menu') ? (n = KTUtil.data(e).get('menu')) : r(),
      ...
      (n.dismiss = function (e, t) {
        return (function (e, t) {
          var n = v(e),
            i = w(n);
          if (null !== n && 'dropdown' === T(n) && (l(n), i.length > 0))
            for (var r = 0, o = i.length; r < o; r++)
              null !== i[r] && 'dropdown' === T(i[r]) && l(tems[r]);
        })(e);
      }),
    ...
    var i = {
      ...
      r = function () {
        (n.options = KTUtil.deepExtend({}, i, t)),
          (n.processing = !1),
          (n.element = e),
          (n.contentElement = T('content')),
          (n.formElement = T('form')),
          (n.inputElement = T('input')),
          (n.spinnerElement = T('spinner')),
          (n.clearElement = T('clear')),
          (n.toggleElement = T('toggle')),
          (n.submitElement = T('submit')),
          (n.toolbarElement = T('toolbar')),
          (n.resultsElement = T('results')),
          (n.suggestionElement = T('suggestion')),
          (n.emptyElement = T('empty')),
