...
MIGRATION_MODULES = {"sites": "one.libraries.django.contrib.sites.migrations"}
...
ADMINS = [("""Bin Nguyen""", "tu.nguyen@risotech.vn")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "One API",
    "DESCRIPTION": "Documentation of API endpoints of One",
    "VERSION": "1.0.0",
